...
import { csharpModules } from "@/data/csharpCourse";
...
const CSharpLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/csharp-learning/topic/${moduleId}/${topicId}`);
  };
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 22.5 hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">159 Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">19,432 Students</span>
                </div>
                
                <Alert>
                  <AlertDescription>
                    C# is a modern, object-oriented programming language developed by Microsoft. 
                    Learn C# from fundamentals to advanced features, perfect for building Windows 
                    applications, web services, and enterprise software.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>• Control flow and methods</li>
                    <li>• Arrays and collections</li>
                    <li>• Object-oriented programming</li>
                    <li>• Advanced C# features (LINQ, async)</li>
