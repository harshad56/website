...
import { cppModules } from "@/data/cppCourse";
...
const CPPLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/cpp-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">⚙️ C++ Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 24.7 hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">166 Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">15,678 Students</span>
                </div>
                
                <Alert>
                  <AlertDescription>
                    C++ is a powerful, high-performance programming language used for systems programming, 
                    game development, and performance-critical applications. Learn C++ from fundamentals 
                    to advanced features including STL, templates, and modern C++.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>• Advanced C++ features (templates, lambdas)</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
