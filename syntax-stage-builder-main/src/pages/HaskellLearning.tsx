...
import { haskellModules } from "@/data/haskellCourse";
import { useAuth } from "@/contexts/AuthContext";
import { BackButton } from "@/components/BackButton";
import SEO from "@/components/SEO";
import { getCourseSEO } from "@/utils/seoData";

const HaskellLearning = () => {
  ...
  const modules = haskellModules;
  const currentModuleData = modules.find((m) => m.id === currentModule);

  const seo = getCourseSEO("haskell");
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">λ Haskell Course</h1>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <Card>
              ...
              <CardContent>
                <Alert>
                  <AlertDescription>Haskell is a purely functional language with strong static typing. Master functors, monads, and elegant code.</AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          </div>
                          ...
                          <Card key={t.id} className="border-l-4 border-l-primary">
                            ...
                            <CardContent>
                              <div className="flex justify-between items-center">
                                ...
                                <Button 
                                  size="sm" 
                                  onClick={() => navigate(`/haskell-learning/topic/${currentModuleData.id}/${t.id}`)}
                                >
...
export default HaskellLearning;
