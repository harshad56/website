...
import { typescriptModules } from "@/data/typescriptCourse";
...
const TypeScriptLearning = () => {
  ...
  const modules = typescriptModules;
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/typescript-learning/topic/${moduleId}/${topicId}`);
  };

  const runCode = () => {
    setOutput("TypeScript code executed successfully (simulation). Use a local environment to run real code.");
  };
  ...
  const seo = getCourseSEO("typescript");
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">📘 TypeScript Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 14+ hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">100+ Practice Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">Thousands of learners</span>
                </div>

                <Alert>
                  <AlertDescription>
                    TypeScript brings static types and powerful tooling to JavaScript. In this course you will
                    move from basic types to generics and advanced React and Node patterns, learning how to build
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• TypeScript syntax and type system fundamentals</li>
                    <li>• Interfaces, classes, and object modeling</li>
                    <li>• Generics and advanced type operators</li>
                    <li>• Typed React components and hooks</li>
                    <li>• Shared types across frontend and backend</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice TypeScript code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
...
export default TypeScriptLearning;
