...
import { kotlinModules } from "@/data/kotlinCourse";
...
const KotlinLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/kotlin-learning/topic/${moduleId}/${topicId}`);
  };

  const runCode = () => {
    setOutput("Kotlin code executed successfully (simulation). Use Android Studio or the Kotlin REPL to run real code.");
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">🤖 Kotlin Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Android and backend learners</span>
                </div>

                <Alert>
                  <AlertDescription>
                    Kotlin is the preferred language for modern Android apps and an excellent choice for JVM
                    backends. This course introduces Kotlin's null safety, concise syntax, and OOP features so
                    you can write safer, more expressive code.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Kotlin syntax, variables, and null safety</li>
                    <li>• Control flow and when expressions</li>
                    <li>• Functions, lambdas, and higher-order utilities</li>
                    <li>• Classes, data classes, inheritance, and interfaces</li>
                    <li>• Sealed classes for expressive state modeling</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice Kotlin code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
