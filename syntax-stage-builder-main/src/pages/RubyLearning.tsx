...
import { rubyModules } from "@/data/rubyCourse";
...
const RubyLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/ruby-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">💎 Ruby Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 9+ hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">60+ Practice Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">Popular in web and scripting</span>
                </div>

                <Alert>
                  <AlertDescription>
                    Ruby focuses on developer happiness and clean code. In this course you will go from
                    basic syntax and control flow to blocks, Enumerable, and the object model that powers Ruby on Rails.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Ruby syntax, objects, and core data types</li>
                    <li>• Arrays, hashes, blocks, and Enumerable patterns</li>
                    <li>• Classes, modules, and mixins</li>
                    <li>• File I/O and practical scripting</li>
                    <li>• How Ruby skills translate to Ruby on Rails</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice Ruby code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
                    ...
                    <div className="flex space-x-2">
                      ...
                      <Button variant="outline" onClick={completeModule}>
