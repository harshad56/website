...
import { rModules } from "@/data/rCourse";
...
const RLearning = () => {
  ...
  const startModule = useCallback((moduleId: number) => {
    ...
    setUserCode("");
    setOutput("");
  }, [setCurrentModule, setUserCode, setOutput]);

  const startTopic = useCallback((moduleId: number, topicId: string) => {
    navigate(`/r-learning/topic/${moduleId}/${topicId}`);
  }, [navigate]);

  const seo = getCourseSEO("r");
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">📊 R Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
              <Badge variant="secondary">Progress: {progress}%</Badge>
              <Button variant="outline" size="sm"><BookOpen className="w-4 h-4 mr-2" />Course Notes</Button>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="lg:col-span-1">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <Alert>
                  <AlertDescription>R is the leading language for statistical computing and data visualization. Master data analysis, ggplot2, and statistical modeling.</AlertDescription>
                </Alert>
                <div className="space-y-2">
                  <h4 className="font-semibold">What you'll learn:</h4>
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• R syntax, vectors, and data frames</li>
                    <li>• Data wrangling with tidyverse</li>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice R code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
