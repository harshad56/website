...
import { dartModules } from "@/data/dartCourse";
...
const DartLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/dart-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">🎯 Dart Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">90+ Practice Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <Alert>
                  <AlertDescription>
                    Dart is Google's language for Flutter development. In this course you will
                    master Dart fundamentals, async programming, and build cross-platform apps.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Dart syntax, types, and null safety</li>
                    <li>• Collections, classes, and mixins</li>
                    <li>• Async programming with Futures and Streams</li>
                    <li>• Flutter widget basics and state management</li>
                    <li>• Building cross-platform mobile apps</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
                          ...
                          {currentModuleData.topics.map((topic) => (
                            <Card key={topic.id} className="border-l-4 border-l-primary">
                              <CardHeader>
                                ...
                                <CardDescription>{topic.content.substring(0, 150)}...</CardDescription>
                              </CardHeader>
                              <CardContent>
                                <div className="flex items-center justify-between">
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice Dart code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
