...
import { rustModules } from "@/data/rustCourse";
...
const RustLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/rust-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">🦀 Rust Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 26 hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">172 Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">8,921 Students</span>
                </div>
                
                <Alert>
                  <AlertDescription>
                    Rust is a systems programming language focused on safety, speed, and concurrency. 
                    Learn Rust from fundamentals to advanced features, perfect for building reliable 
                    and performant systems software.
                  </AlertDescription>
                </Alert>
