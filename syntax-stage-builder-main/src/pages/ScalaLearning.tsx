...
import { scalaModules } from "@/data/scalaCourse";
...
const ScalaLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/scala-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">⚖️ Scala Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">
                    Popular for backend services and big data (Spark)
                  </span>
                </div>

                <Alert>
                  <AlertDescription>
                    Scala mixes functional and object-oriented programming on top of the JVM. In this course
                    you will learn the language fundamentals, collections, and patterns used in real Scala
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• Scala syntax, values, variables, and types</li>
                    <li>• Immutable collections and higher-order functions</li>
                    <li>• Options, Either, and safer error handling</li>
                    <li>• Classes, traits, and case classes</li>
                    <li>• Basics of concurrency with Futures</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice Scala code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
