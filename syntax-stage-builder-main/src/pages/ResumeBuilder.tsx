  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 overflow-auto">
      ...
      >
        ...
        {/* Action Buttons */}
        <div className="sticky bottom-0 bg-slate-900 p-4 flex gap-4 justify-center border-t border-white/10">
...
const TemplateCard = ({ 
  ...
  >
    {/* Mini Preview */}
    <div className="h-32 relative" style={{ background: template.color }}>
    ...
    <div className="bg-slate-800 p-3">
      ...
      <span className="text-white/50 text-xs capitalize">{template.style}</span>
    </div>
  </motion.div>
);
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        >
          <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <Layout className="w-5 h-5 text-indigo-400" aria-hidden="true" />
            Choose Your Template
          </h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {(showAllTemplates ? templates : templates.slice(0, 12)).map((template) => (
              <TemplateCard
                key={template.id}
                template={template}
                ...
                onPreview={() => {
                  ...
                  // When previewing from the template card, always show the sample example
          ...
          {templates.length > 12 && (
            <div className="flex justify-center mt-6">
              <Button
                ...
                variant="outline"
                className="border-indigo-500/30 text-indigo-300 hover:bg-indigo-500/20 hover:text-indigo-200 transition-all"
              >
                {showAllTemplates ? (
                  <>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className="grid grid-cols-5 bg-slate-800/50 border border-white/10 p-1">
                <TabsTrigger value="personal" className="data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white text-xs sm:text-sm">
                  <User className="w-4 h-4 mr-1 hidden sm:block" />
                  Personal
                </TabsTrigger>
                <TabsTrigger value="experience" className="data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white text-xs sm:text-sm">
                  <Briefcase className="w-4 h-4 mr-1 hidden sm:block" />
                  Experience
                </TabsTrigger>
                <TabsTrigger value="education" className="data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white text-xs sm:text-sm">
                  <GraduationCap className="w-4 h-4 mr-1 hidden sm:block" />
                  Education
                </TabsTrigger>
                <TabsTrigger value="skills" className="data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white text-xs sm:text-sm">
                  <Code className="w-4 h-4 mr-1 hidden sm:block" />
                  Skills
                </TabsTrigger>
                <TabsTrigger value="projects" className="data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white text-xs sm:text-sm">
                  <Award className="w-4 h-4 mr-1 hidden sm:block" />
                  Projects
                </TabsTrigger>
              </TabsList>
                        ...
                        >
                          ...
                          <div className="grid md:grid-cols-2 gap-3">
                            ...
                            <Input
                              ...
                              className="bg-slate-800/50 border-white/20 text-white md:col-span-2"
                            />
                          </div>
                          <Textarea
            ...
            <Card className="bg-gradient-to-br from-indigo-900/40 to-purple-900/40 border-indigo-500/30">
              ...
              <CardContent className="space-y-4">
                ...
                <Tabs value={aiFeature} onValueChange={(v) => setAiFeature(v as any)} className="w-full">
                  <TabsList className="grid grid-cols-3 bg-slate-900/50 border border-white/10 p-1 h-auto">
                    <TabsTrigger value="suggestions" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      Ideas
                    </TabsTrigger>
                    <TabsTrigger value="summary" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      Summary
                    </TabsTrigger>
                    <TabsTrigger value="improve" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      Improve
                    </TabsTrigger>
                    <TabsTrigger value="ats" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      ATS
                    </TabsTrigger>
                    <TabsTrigger value="keywords" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      Keywords
                    </TabsTrigger>
                    <TabsTrigger value="analyze" className="text-xs data-[state=active]:bg-indigo-500 text-white/70 data-[state=active]:text-white py-1.5">
                      Analyze
                    </TabsTrigger>
                  </TabsList>
            ...
            <Card className="bg-slate-900/70 border-white/10">
              ...
              <CardContent className="space-y-3">
                ...
                <Button
                  ...
                  variant="outline"
                  className="w-full border-white/30 text-white bg-slate-700/50 hover:bg-slate-600/50"
                >
