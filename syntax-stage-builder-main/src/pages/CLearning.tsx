...
import { cModules } from "@/data/cCourse";
...
const CLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/c-learning/topic/${moduleId}/${topicId}`);
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">🔧 C Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Total Duration: 10+ hours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Trophy className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">70+ Practice Exercises</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Users className="w-4 h-4 text-muted-foreground" />
                  <span className="text-sm text-muted-foreground">
                    Foundation for systems, embedded, and OS programming
                  </span>
                </div>

                <Alert>
                  <AlertDescription>
                    C gives you low-level control over memory and performance. In this course you will learn
                    how to write safe, clear C code that prepares you for embedded systems, operating systems,
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• C syntax, compilation, and program structure</li>
                    <li>• Data types, functions, and control flow</li>
                    <li>• Arrays, pointers, and dynamic memory</li>
                    <li>• Structs, file I/O, and error handling</li>
                    <li>• Practical debugging and best practices</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice C code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
