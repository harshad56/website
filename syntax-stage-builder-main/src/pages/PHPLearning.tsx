...
import { phpModules } from "@/data/phpCourse";
...
const PHPLearning = () => {
  ...
  const startTopic = (moduleId: number, topicId: string) => {
    navigate(`/php-learning/topic/${moduleId}/${topicId}`);
  };

  const runCode = () => {
    setOutput("PHP code executed successfully (simulation). Run this code on a local PHP server to see real output.");
  };
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <h1 className="text-2xl font-bold">🐘 PHP Programming Course</h1>
            </div>
            <div className="flex items-center space-x-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-muted-foreground">Web development learners</span>
                </div>

                <Alert>
                  <AlertDescription>
                    PHP powers a large portion of the web, from WordPress sites to modern frameworks like
                    Laravel. This course helps you understand how PHP scripts respond to requests, manage
                    forms, and build dynamic pages.
                  </AlertDescription>
                </Alert>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    <li>• PHP syntax, variables, and basic types</li>
                    <li>• Control flow for dynamic responses</li>
                    <li>• Handling user input via GET, POST, and other superglobals</li>
                    <li>• Functions, arrays, and organizing common logic</li>
                    <li>• Form handling and simple session-based state</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
              ...
              <TabsContent value="practice" className="space-y-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Practice PHP code in a simulated editor.</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div>
