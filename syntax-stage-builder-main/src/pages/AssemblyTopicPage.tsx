...
const AssemblyTopicPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b"><div className="container mx-auto px-6 py-4 flex justify-between"><div className="flex items-center gap-4"><Link to={`/assembly-learning?module=${currentModule.id}`}><Button variant="outline" size="sm">← Back</Button></Link><h1 className="text-xl font-bold">{currentModule.title}</h1></div><Badge>{currentTopic.difficulty}</Badge></div></header>
