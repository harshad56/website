...
const AssemblyTopicPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b"><div className="container mx-auto px-6 py-4 flex justify-between"><div className="flex items-center gap-4">              <BackButton label="Back to Module" fallback="/assembly-learning" className="mb-0" /><h1 className="text-xl font-bold">{currentModule.title}</h1></div><Badge>{currentTopic.difficulty}</Badge></div></header>
