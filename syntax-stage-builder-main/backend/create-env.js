...
try {
    ...
    console.log('📝 Please update SUPABASE_SERVICE_ROLE_KEY with your actual service role key from Supabase dashboard.');
    console.log('🔗 Go to: https://supabase.com/dashboard/project/sozycfpmxirbwmlwkzdp/settings/api');
} catch (error) {
